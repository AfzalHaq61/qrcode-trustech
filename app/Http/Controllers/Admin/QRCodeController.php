...
class QRCodeController extends Controller
{
    ...
    public function updateQrCodeStatus(Request $request)
    {
        ...
        if ($qr_details == null) {
            ...
            return redirect()->route('admin.all.qr')->with('success', trans('QR Code Status Updated Successfully!'));
        }
    }
    ...
    public function deleteQrCode(Request $request)
    {
        ...
        return redirect()->route('admin.all.qr')->with('success', trans('QR Code Deleted Successfully!'));
    }
