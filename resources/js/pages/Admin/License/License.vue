                    ...
                    <div>
                        ...
                        <div class="sm:col-span-3">
                            <input
                                ...
                                required
                            />
                            <span class="mb-2 ml-1 font-bold text-[10px] text-themeColor"><a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-">Where is my purchase code?.</a></span>
                        </div> 
                    </div>
                </div>
