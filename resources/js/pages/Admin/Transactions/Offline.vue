<template>
    <Head title="Offline Transactions Index" />
    <AdminLayout>
                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6>Offline Transactions Table</h6>
                        </div>
                                ...
                                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                    ...
                                    <tbody>
                                        <tr v-for="(transaction, index) in transactions.data" :key="transaction.id">
                                            ...
                                            <td
                                                class="px-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{ transaction.name }}
                                                </p>
                                            </td>
                                            <td
                                                class="px-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{
                                                    transaction.payment_gateway_name }}</p>
                                            </td>
                                            <td
                                                class="px-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <!-- {{ transaction.transaction_currency }} {{ currency.iso_code }} -->
                                                <!-- <span v-if="transaction.transaction_currency === currency.iso_code">{{ currency.symbol }}</span> -->
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{
                                                    currencySymbol(transaction.transaction_currency) }}{{
        transaction.transaction_amount }}</p>
                                            </td>
                                            <td
                                            ...
                                            <td
                                                ...
                                                <Link v-if="transaction.payment_status != 'PENDING'"
