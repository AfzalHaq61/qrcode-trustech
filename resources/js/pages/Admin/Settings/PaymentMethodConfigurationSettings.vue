        ...
        <div class="col-span-8 w-full px-6 py-6 mx-auto">
            ...
            <form @submit.prevent="submit" role="form">
                ...
                <div class="mt-10 pb-0 mb-0  border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">PayPal Settings</h6>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-3">
                            <select v-model="form.paypal_mode" id="paypal_mode" name="paypal_mode" required class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow">
                ...
                <!-- Razorpay Settings -->
                <div class="mt-10 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Razorpay Settings</h6>
                </div>
                ...
                <!-- Stripe Settings -->
                <div class="mt-10 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Stripe Settings</h6>
                </div>
                ...
                <div class="mt-10 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Offline (Bank Transfer) Settings</h6>
                </div>
