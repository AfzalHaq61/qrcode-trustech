                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-3">
                            <select v-model="form.paypal_mode" id="paypal_mode" name="paypal_mode" required class="focus:ring-themeColor focus:shadow-themeColor focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow">
