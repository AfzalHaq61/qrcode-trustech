        ...
        <div class="col-span-8 w-full px-6 py-6 mx-auto">
            ...
            <form @submit.prevent="submit" role="form">
                ...
                <div class="mt-10 pb-0 mb-0  border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Google reCAPTCHA Configuration Settings</h6>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6  sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <span class="mb-2 ml-1 font-bold text-[10px] text-slate-700">if you did not get a reCAPTCHA (v2 Checkbox), create a <a href="https://www.google.com/recaptcha/about/" class="text-fuchsia-600/100 text-sm">reCAPTCHA</a>.</span>
                        </div>                 
                    </div>
                ...
                <div class="mt-10 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Google OAuth Configuration Settings</h6>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-12">
                    <div class="sm:col-span-8">
                        <span class="mb-2 ml-1 font-bold text-[10px] text-slate-700">if you did not get a google OAuth Client ID & Secret Key, follow a <a href="https://support.google.com/cloud/answer/6158849?hl=en#zippy=%2Cuser-consent%2Cpublic-and-internal-applications%2Cauthorized-domains/" class="text-fuchsia-600/100 text-sm">steps</a>.</span>
                    </div>
                </div>  

                <!-- Google Analytics ID -->
                <div class="mt-10 pb-0 mb-0  border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="text-fuchsia-600/100">Google Analytics Configuration Settings</h6>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <input
                            ...
                            required
                        />
                        <span class="mb-2 ml-1 font-bold text-[10px] text-slate-700">if you did not get a google analytics id, create a <a href="https://analytics.google.com/analytics/web/" class="text-fuchsia-600/100 text-sm">new analytics id.</a></span>
                    </div>
                </div>
