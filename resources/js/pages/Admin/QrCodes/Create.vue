                                    ...
                                    <div class="p-6 overflow-x-auto">
                                        ...
                                        <div class='mb-6'>
                                            ...
                                            <TextInput id="name" type="text" v-model="form.name" autofocus
                                                placeholder="Name..." minlength="3" maxlength="100" class="focus:ring-themeColor focus:shadow-themeColor" required />
                                        ...
                                        <div v-if="form.qrcode_type === 'pdf'" class="mb-6">
                                            <div class="mb-6">
                                                <Label class="mb-2 ml-1 font-bold text-xs text-slate-700" for="phone">PDF File
                                                    <span class="text-red-600">*</span></Label>
                                                <input @change="getPdfImage($event)" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow"
                                    ...
                                    <div class="p-6 overflow-x-auto">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="flex space-x-5">
                                                ...
                                                <div>
                                                    <Label @click="qrCodeStyle('dot')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_style === 'dot' }" class="font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="qrcode_style">
                                                        <span>
                                                ...
                                                <div>
                                                    <Label @click="qrCodeStyle('round')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_style === 'round' }" class="font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="qrcode_style">
                                                        <span>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="flex space-x-5">
                                                <div>
                                                    <Label @click="qrColorStyle('color')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.color_style === 'color' }" class="font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="qrcode_style">
                                                        <span>
                                                ...
                                                <div>
                                                    <Label @click="qrColorStyle('gradient')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.color_style === 'gradient' }" class="font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-soft-primary-outline transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="qrcode_style">
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div v-if="form.color_style === 'gradient'" class="mb-6">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <!-- horizontal -->
                                                    <div>
                                                        <Label @click="qrCodeGradientType('horizontal')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.foreground_gradient_type === 'horizontal' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Horizontal
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- inverse_diagonal -->
                                                    <div>
                                                        <Label @click="qrCodeGradientType('inverse_diagonal')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.foreground_gradient_type === 'inverse_diagonal' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Inverse Diagonal
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- radial -->
                                                    <div>
                                                        <Label @click="qrCodeGradientType('radial')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.foreground_gradient_type === 'radial' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Radial
                                                            </span>
                                                        </Label>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div class="mb-5 flex justify-between items-center focus:shad ow-soft-primary-outline text-sm leading-5.6 ease-soft  w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-1 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow">
                                                ...
                                                <div class="flex justify-between items-center focus:shad ow-soft-primary-outline text-sm leading-5.6 ease-soft  w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-1 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow">
                                        ...
                                        <div class="mb-6">
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-2">
                                                    <div>
                                                        <Label @click="needEyeColor('1')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.need_eye_color === '1' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Yes
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <div>
                                                        <Label @click="needEyeColor('2')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.need_eye_color === '2' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                No
                                                            </span>
                                                        </Label>
                                        ...
                                        <div v-if="form.need_eye_color === '1'" class="mb-6">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-5">
                                                    ...
                                                    <!-- right -->
                                                    <div>
                                                        <Label @click="eyeColorPosition('1')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.eyeColor_position === '1' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="eyeColor_position">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- bottom -->
                                                    <div>
                                                        <Label @click="eyeColorPosition('2')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.eyeColor_position === '2' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="eyeColor_position">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-5">
                                                    <!-- Square -->
                                                    <div>
                                                        <Label @click="eyeColorStyle('square')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.eye_color_style === 'square' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="eyeColor_position">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Square -->
                                                    <div>
                                                        <Label @click="eyeColorStyle('circle')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.eye_color_style === 'circle' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-1 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="eyeColor_position">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input @change="getLogoImage($event)" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow"
                                        ...
                                        <div class="mb-6">
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-2">
                                                    <!-- small -->
                                                    <div>
                                                        <Label @click="uploadLogoSize('0.1')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.upload_logo_size === '0.1' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Small
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- medium -->
                                                    <div>
                                                        <Label @click="uploadLogoSize('0.2')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.upload_logo_size === '0.2' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Medium
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- large -->
                                                    <div>
                                                        <Label @click="uploadLogoSize('0.5')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.upload_logo_size === '0.5' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Large
                                                            </span>
                                                        </Label>
                                        ...
                                        <div class="mb-6">
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-2">
                                                    <!-- basic -->
                                                    <div>
                                                        <Label @click="downloadQuality('200')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.size === '200' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Basic
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- normal -->
                                                    <div>
                                                        <Label @click="downloadQuality('500')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.size === '500' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Normal
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- fine -->
                                                    <div>
                                                        <Label @click="downloadQuality('1000')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.size === '1000' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Fine
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- high -->
                                                    <div>
                                                        <Label @click="downloadQuality('1500')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.size === '1500' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                High
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- very high -->
                                                    <div>
                                                        <Label @click="downloadQuality('2000')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.size === '2000' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Very High
                                                            </span>
                                                        </Label>
                                        ...
                                        <div class="mb-6">
                                            <div class="mb-6">
                                                ...
                                                <div class="flex space-x-2">
                                                    <!-- low -->
                                                    <div>
                                                        <Label @click="qrCodeEcc('L')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_ecc === 'L' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Low
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- medium -->
                                                    <div>
                                                        <Label @click="qrCodeEcc('M')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_ecc === 'M' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Medium
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- quartile -->
                                                    <div>
                                                        <Label @click="qrCodeEcc('Q')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_ecc === 'Q' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                Quartile
                                                            </span>
                                                        </Label>
                                                    ...
                                                    <!-- high -->
                                                    <div>
                                                        <Label @click="qrCodeEcc('H')" :class="{ 'border-themeColor shadow-themeColor focus:shadow-themeColor shadow-soft-primary-outline': form.qrcode_ecc === 'H' }" class="block font-bold text-xs text-gray-600 rounded bg-white bg-clip-padding p-2 hover:shadow-themeColor transition-all border border-solid border-gray-300 hover:border-themeColor hover:outline-none hover:transition-shadow cursor-pointer" for="foreground_gradient_type">
                                                            <span>
                                                                High
                                                            </span>
                                                        </Label>
