...
const form = useForm({
    ...
    color_style: 'color',
    color: '#000000',
    foreground_gradient_type: 'vertical',
    ...
    eye_color: '#000000',
    eyeColor_position: '0',
    eye_color_style: 'square',
    upload_logo: '',
    upload_logo_size: '0.2',
    size: '500',
    qrcode_ecc: 'L',
});
...
const regenerateQrCode = async () => {
    try {
        const response = await axios.post('regenerate-qr', form);
