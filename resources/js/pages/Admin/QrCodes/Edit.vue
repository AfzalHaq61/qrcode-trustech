                                    ...
                                    <div class="p-6 overflow-x-auto">
                                        ...
                                        <div class='mb-6'>
                                            ...
                                            <TextInput id="name" type="text" v-model="form.name" autofocus
                                                placeholder="Name..." minlength="3" maxlength="100" required class="focus:shadow-themeColor focus:ring-themeColor"/>
                                        ...
                                        <div v-if="form.qrcode_type === 'url'" class="mb-6">
                                            <Label class="mb-2 ml-1 font-bold text-xs text-slate-700" for="url">Link Url
                                                <span class="text-red-600">*</span></Label>
                                            <input class="focus:shadow-themeColor focus:ring-themeColor focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow"
                                        ...
                                        <div v-if="form.qrcode_type === 'text'" class="mb-6">
                                            <Label class="mb-2 ml-1 font-bold text-xs text-slate-700" for="content">Content
                                                <span class="text-red-600">*</span></Label>
                                            <textarea class="focus:shadow-themeColor focus:ring-themeColor focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-themeColor focus:outline-none focus:transition-shadow"
