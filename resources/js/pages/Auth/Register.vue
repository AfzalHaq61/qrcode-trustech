<script setup>
import GuestRegesterLayout from '@/Layouts/GuestRegesterLayout.vue';
                        ...
                        <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                            ...
                            <div class="flex-auto p-6">
                                <form @submit.prevent="submit" role="form text-left">
                                    ...
                                    <div class="min-h-6 pl-6.92 block">
                                    ...
                                    <div class="text-center">
                                        <RegisterButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                                            Sign up
                                        </RegisterButton>
                                    </div>

                                    <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <Link :href="route('login')" class="font-bold text-slate-700">Sign in</Link></p>
