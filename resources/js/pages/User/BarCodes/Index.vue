            ...
            <div class="flex flex-wrap -mx-3">
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div
                            class="flex items-center justify-between p-6 pb-0 mb-2 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6>Barcodes</h6>
                        ...
                        <div class="flex-auto px-0 pt-0 pb-2">
                            <div class="p-0 overflow-x-auto">
                                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                    ...
                                    <tbody>
                                        <tr v-for="(bar_code, index) in bar_codes.data" :key="bar_code.id">
                                            <td
                                            ...
                                            <td
                                                ...
                                                <Menu as="div" class="relative inline-block text-left">
                                                    <div>
                                                        <MenuButton>
                                                            <span
                                                                class="text-xs font-semibold leading-tight text-slate-400 mr-2">Actions</span>
                                                            <svg class="w-2 transition-all duration-200 transform" :class="{
                                                                ...
                                                                aria-hidden="true">
                                                                <path d="M15 1.2l-7 7-7-7" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                    ...
                                                    <transition enter-active-class="transition ease-out duration-100"
                                                        ...
                                                        <MenuItems
                                                            class="absolute right-0 z-100 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                            <div class="py-1">
                                                                <MenuItem v-slot="{ active }">
                                                                    <Link
                                                                        :href="route('user.download.barcode', { id: bar_code.barcode_id })"
                                                                        :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-xs font-semibold leading-tight text-slate-400']">
                                                                        Download Barcode
                                                                    </Link>
                                                                </MenuItem>
                                                                <MenuItem v-slot="{ active }">
                                                                    <Link
                                                                        :href="route('user.edit.barcode', { id: bar_code.barcode_id })"
                                                                        :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-xs font-semibold leading-tight text-slate-400']">
                                                                        Edit
                                                                    </Link>
                                                                </MenuItem>
                                                                <MenuItem v-slot="{ active }">
                                                                    <Link :href="route('user.update.barcode.status', { id: bar_code.barcode_id })" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-xs font-semibold leading-tight text-slate-400']"><span v-if="bar_code.status === 0">Activate</span><span v-else>Deactivate</span></Link>
                                                                </MenuItem>
                                                                <MenuItem v-slot="{ active }">
                                                                    <Link :href="route('user.delete.barcode', { id: bar_code.barcode_id })" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-xs font-semibold leading-tight text-slate-400']">Delete</Link>
                                                                </MenuItem>
                                                            </div>
                                                        </MenuItems>
                                                    </transition>
