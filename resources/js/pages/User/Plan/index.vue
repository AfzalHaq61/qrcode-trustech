    ...
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex flex-wrap mx-3">
            <div class="flex-none w-full max-w-full px-3  ">
                <div class="relative flex flex-col min-w-0 mb-6 h-48 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                      <h1>{{ values }}</h1>
                        <p class="text-sm font-bold">My Plan</p>
                        <p class="text-base font-bold">Daily</p>
                        <p class="text-base">Remaning Days : 11332</p>
                        <div class="space-x-3 pb-2">
                            <PrimaryButton>Cancel Subscription</PrimaryButton>
                            <PrimaryButton>Renew</PrimaryButton>
        ...
        <div class="grid grid-cols-3 gap-1 px-6">
                ...
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 relative overflow-hidden">
                    ...
                    <ul role="list" class="space-y-2 my-7">
                        <li class="flex space-x-3">
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Invoiced every year </span>
                        </li>
                        <li class="flex space-x-3">
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">14 QRCode Types ?</span>
                        </li>
                        <li class="flex space-x-3">
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Unlimited QRCodes</span>
                        </li>
                        <li class="flex space-x-3">
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Unlimited Barcodes</span>
                        </li>
                        <li class="flex space-x-3">
                    ...
                    <button type="button" class="text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-xs ease-soft-in tracking-tight-soft bg-gradient-to-tl from-blue-600 to-cyan-400 hover:scale-102 hover:shadow-soft-xs active:opacity-85 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose plan</button>
                </div>
            </div> -->
<!-- 
            <div>
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 relative overflow-hidden">
                    ...
                    <ul role="list" class="space-y-2 my-7">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Invoiced each semester</span>
                        </li>
                        <li class="flex space-x-3">
                        ...
                        <li class="flex space-x-3">
                            <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">100 Barcodes</span>
                        </li>
                        <li class="flex space-x-3">
...
<script setup>
    ...
    import {ref} from 'vue'
    const data = ref([
     {index:0,months:3,monthlyPrice:30,active:0},
     {index:1,months:7,monthlyPrice:20,active:1},
     {index:2,months:5,monthlyPrice:70,active:0},
    ]);
</script>
