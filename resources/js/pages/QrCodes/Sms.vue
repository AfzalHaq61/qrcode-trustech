    ...
    <div class="flex flex-col items-center justify-center w-screen h-screen">
        ...
        <div class="p-6 w-1/2 relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div class="mb-2">
                ...
                <span class="block text-sm text-slate-500 bg-gray-100 p-2 rounded">{{ qrcodeDetails.sms_phone_value }}</span>
            </div>
            <div class="mb-2">
                <Label class="mb-1 block font-bold text-sm text-slate-700">Messege</Label>
                <span class="block text-sm text-slate-500 bg-gray-100 p-2 rounded">{{ qrcodeDetails.sms_msg_value }}</span>
            </div>
        </div>
    </div>
</template>
